...
Skybox::Skybox()
{
    ...
    skybox_shader = Shader("resources/shaders/skybox.vert", "resources/shaders/skybox.frag");
...
void Skybox::draw(const glm::mat4& view, const glm::mat4& projection)
{
    ...
    glm::mat4 projection_matrix = projection;

    skybox_shader.set_mat4("view", skybox_view);
